            ...
            if (evt.detail.cursorEl.id == "cursor") {
              ...
              if (currentDoc.paused) {
                ...
                if (
                  ...
                  document
                    .getElementById(`ele${element.id.substring(0, 5)}play`)
                    .remove();
                }
                avideo.appendChild(pauseButton);
                setTimeout(() => {
                  document
                    .getElementById(`ele${element.id.substring(0, 5)}pause`)
                    .remove();
                }, 1500);
                //hide play icon
    ...
    <>
      ...
      <div id="uiScanning" className="hidden">
        <div class="inner">
          ...
          <strong id="uiScanningText">Scan the marker</strong>
