    ...
    allData.forEach((element, idx) => {
      ...
      if (element.type === "video") {
        setTimeout(() => {
          currentDoc.currentTime = 0.1;
          currentDoc.play();
          const avideo = document.querySelector(
  ...
  return (
    <>
      ...
      <div id="uiScanning" className="hidden">
        <div class="inner">
          <img id="scanIco" src={scanIco} alt="scanIco" />
          <img id="scanLogo" src={scanLogo} alt="scanLogo" />
      ...
      <a-scene
        ...
        mindar-image={`imageTargetSrc: ${
          ...
          filterMinCF: -0.0000000000018606660660503;
          filterBeta: 0.15;
          warmupTolerance: 1;
          missTolerance: 3;
          stayVisible: true;
